variable "eks_cluster_name" {
  description = "Nome do cluster EKS usado para descobrir endpoint, CA e token de autenticacao."
  type        = string
...
variable "cluster_name" {
  description = "Nome do cluster exibido no Dynatrace. Se nulo, usa eks_cluster_name."
  type        = string
  default     = null
}
...
variable "aws_region" {
  description = "Regiao AWS do cluster EKS. Se nula, usa a regiao do provider AWS."
  type        = string
  default     = null
}
